...
import Form from "../../../Modules/Users/Inertia/Form";
...
const Edit = () => {
  ...
  const { data, setData, errors, put, processing } = useForm({
    ...
    id_role : props.user_role || ""
  });
  function handleSubmit(e) {
    e.preventDefault();
    put(route("users.update", props.users.id_user));
  }
          ...
          <div className="col-md-12">
            <div className="card">
              <div className="card-header row">
                <div className="col-12">
                  <div className="card-title">Form Users</div>
...
Edit.layout = (page) => <Layout children={page} title="Edit Users" />;
export default Edit;
