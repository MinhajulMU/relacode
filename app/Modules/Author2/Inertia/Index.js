    ...
    <React.Fragment>
      <div className="page-inner">
        <div className="page-header row">
          ...
          <div className="col-6">
            <h4 className="page-title">Author2</h4>
          </div>
          ...
          <div className="col-md-12">
            <div className="card">
              <div className="card-header row">
                <div className="col-6">
                  <div className="card-title">Manajemen Data Author2</div>
                  <div className="card-category">Tabel Author2</div>
                </div>
                <div className="col-6 text-right">
                  <AllowAction module="author2" action="create">
                    <InertiaLink href={route("author2.create")}>
                      <button className="btn btn-primary btn-round ml-auto">
                        <i className="fa fa-plus"></i> Tambah Author2
                      </button>
                    </InertiaLink>
                  </AllowAction>
                </div>
        ...
        <td>{items.alamat}</td>
                            <td>
                              <div className="form-button-action">
                                <AllowAction module="author2" action="read">
                                  <Detail>
                                    {route("author2.show", items.id_author2)}
                                  </Detail>
                                </AllowAction>

                                <AllowAction module="author2" action="update">
                                  <Edit>
                                    {route("author2.edit", items.id_author2)}
                                  </Edit>
                                </AllowAction>

                                <AllowAction module="author2" action="delete">
                                  <Delete
                                    url={route(
                                      "author2.destroy",
                                      items.id_author2
...
Index.layout = (page) => <Layout children={page} title="Author2" />;
