    ...
    <React.Fragment>
      <div className="page-inner">
        <div className="page-header row">
          ...
          <div className="col-6">
            <h4 className="page-title">Menu Grup</h4>
          </div>
          ...
          <div className="col-md-12">
            <div className="card">
              <div className="card-header row">
                <div className="col-6">
                  <div className="card-title">Manajemen Data Menu Grup</div>
                  <div className="card-category">Tabel Menu Grup</div>
                </div>
                <div className="col-6 text-right">
                  <AllowAction module="menu-grup" action="create">
                    <InertiaLink href={route("menu-grup.create")}>
                      <button className="btn btn-primary btn-round ml-auto">
                        <i className="fa fa-plus"></i> Tambah Menu Grup
                      </button>
                    </InertiaLink>
                  </AllowAction>
                </div>
                      ...
                      {data.data.length > 0 ? (
                        data.data.map((items, index) => (
                          <tr key={index}>
                            ...
                            <td>{items.nm_menu_grup}</td>
                            <td>{items.icon}</td>
                            <td>{items.urutan}</td>
                            <td>
                              <div className="form-button-action">
                                <AllowAction module="menu-grup" action="read">
                                  <Detail>
                                    {route(
                                      "menu-grup.show",
                                      items.id_menu_grup
                                ...
                                <AllowAction module="menu-grup" action="update">
                                  <Edit>
                                    {route(
                                      "menu-grup.edit",
                                      items.id_menu_grup
                                ...
                                <AllowAction module="menu-grup" action="delete">
                                  <Delete
                                    url={route(
                                      "menu-grup.destroy",
                                      items.id_menu_grup
...
Index.layout = (page) => <Layout children={page} title="Menu Grup" />;
